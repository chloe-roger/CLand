...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "Gemfile", "Gemfile.lock.development", "History.txt", "LICENSE", "README.rdoc", "Rakefile", "lib/orm_adapter.rb", "lib/orm_adapter/adapters/active_record.rb", "lib/orm_adapter/adapters/data_mapper.rb", "lib/orm_adapter/adapters/mongoid.rb", "lib/orm_adapter/base.rb", "lib/orm_adapter/to_adapter.rb", "lib/orm_adapter/version.rb", "orm_adapter.gemspec", "spec/orm_adapter/adapters/active_record_spec.rb", "spec/orm_adapter/adapters/data_mapper_spec.rb", "spec/orm_adapter/adapters/mongoid_spec.rb", "spec/orm_adapter/base_spec.rb", "spec/orm_adapter/example_app_shared.rb", "spec/orm_adapter_spec.rb", "spec/spec_helper.rb"]
